...
export default function Header({ studentId, studentUser, onLogout, currentPage, setCurrentPage, showAlert, showConfirm }) {
    ...
    const displayName = studentUser?.fullName || 'Sinh viên';
    const displayRole = studentUser?.studentId
        ? `Sinh viên - ${studentUser.studentId}`
        : 'Sinh viên';
